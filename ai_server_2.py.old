...
# file:// (Origin: null) 포함해서 로컬에서 넉넉하게 허용
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://wongikim88-coder.github.io","http://localhost:5500","http://127.0.0.1:5500"],
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("ai_server_2:app", host=APP_HOST, port=APP_PORT)
